    ...
    <div class="absolute top-[100vh] left-[10vw] w-full z-20">
      ...
      >
        ...
        <p class="text-base leading-relaxed">
          The Central Pollution Control Board’s (CPCB) monitoring during this Maha Kumbh as well as that in 2013 showed high levels of fecal coli, more so during the Amrit Snan (auspicious bathing) days. 
There have been deliberate efforts to respond and mitigate this by allowing adequate flows in the river. As witnessed at the Kumbh of Prayag Raj, there has also been an upsurge of environmental 
action to mitigate the impact, both by the state institutions and the civic society.
        </p>
      </div>
      ...
      >
        ...
        <p class="text-base leading-relaxed">
          With all attempts at waste 
management, visible piles of floral waste congregated along the banks, where sanitation 
teams frequented discarded offerings for disposal. Significantly, vendors stood 
strategically on both riverbanks and the Panda Pujaris (priests) to make it convenient for 
pilgrims.
        </p>
      </div>
      ...
      >
        ...
        <p class="text-base leading-relaxed">
          During observations, it was seen that Deep Daan — offering lighted lamps to the river — 
was one of the most commonly done rituals after the religious Snan or Aarti sessions. There 
were several vendors positioned around the banks selling Deep Daan kits, usually 
consisting of a small disposable dish containing flowers, vermilion (Kumkum/Sindoor), 
incense sticks, and a lamp. Worshipers were spotted moving towards the riverbank 
boundaries, especially by the floating interceptors that distinguish shallow banks from the 
main channel, where they lit their lamps and let them float on the water. 
        </p>
      </div>
    </div>
  </section>
