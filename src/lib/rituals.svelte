...
>
  <div>
    ...
    <p class="mb-6">
      The Kumbh Mela is an assembly of rituals, with Amrit Snan (earlier Shahi
      Snan) being the most prominent and prevalent among all of them. These
      traditions, rooted deep within the Hindu cosmography, mythology, and yogic
      practices, serve a variety of purposes, ranging from spiritual cleansing
      to affirming social bonds. Most interviewees underscored that attending
      the Maha Kumbh at Prayagraj was not an individual pilgrimage but a moment
      of history that would be a memory for generations to come, considering the
      occurrence of the Maha Kumbh after 144 years.
    </p>

    <p class="mb-6">
      In this section, we have detailed the rituals and their connections to
      mythology while interpreting them through reflections drawn from our field
      observations. The section details the range of rituals with water at its
      core, ranging from Snans as the most prominent ritual and others including
      Kalpavas, Aarti, and various Daans. It also describes the material
      engagement at the Maha Kumbh that largely comprises natural materials such
      as flowers, cereals (barley, rice, sesame seeds), milk, honey, etc. These
      engagements reflect a deep, ecologically sensitive engagement with the
      river in ritual performance.
    </p>
...
<section class="relative col-span-full bg-[#cce2cf] px-4 py-8">
  <!-- Scrollable Container -->
  <div
    bind:this={scrollContainer}
    class="flex gap-16 overflow-x-auto overflow-y-hidden hide-scrollbar scroll-smooth"
  >
      ...
      >
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <p class="mt-2">
              Millions of flickering lamps ignite the confluence, creating a
              river of fire that mirrors the stars.
            </p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div class="leading-relaxed space-y-4">
          ...
          <div>
            <strong>Magnitude and Impact:</strong>
            <p class="mt-2">
              66 Crore visitors visited during the 45 days of Maha Kumbh, Snan
              was the most common ritual
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="flex flex-col md:flex-row items-center">
      ...
      >
        ...
        <div class="leading-relaxed space-y-4">
          <div>
            <p class="mt-1">
              Kalpavas is a profound practice leading a minimalist life,
              observing fasting, and performing various rituals along the banks
              of the confluence for their spiritual evolution
            </p>
          </div>
    ...
    <div class="flex flex-col md:flex-row items-center">
      ...
      >
        ...
        <div class="leading-relaxed space-y-4">
          <div>
            <p class="mt-1">
              Daan is a holy 'act of giving' that blesses the giver and helps
              the receiver. It is said to cleanse the soul and wash away past
              karmic sins
            </p>
          </div>
          ...
          <div>
            ...
            <div class="mt-2">
              ...
              />
              <p class="annotation leading-snug">
                Flowers, Deeps (earthen, flour-based, or paper based), incense
                sticks, rice and Kumkum (vermillion).
              </p>
            </div>
          </div>
          ...
          <div>
            <strong>Magnitude and Impact:</strong>
            <p class="mt-2">
              Some of the most prevalent rituals (usually at least one person
              from the family/ group afloats Deeps).
            </p>
          </div>
        </div>
      </div>
  ...
  <button
    on:click={scrollLeft}
    class="absolute left-2 top-1/2 -translate-y-1/2 bg-black/20 text-white p-3 rounded hover:bg-black/30"
  >
    &#8592;
  </button>
  ...
  <button
    ...
    class="absolute right-2 top-1/2 -translate-y-1/2 bg-black/20 text-white p-3 rounded hover:bg-black/30"
  >
    &#8594;
  </button>
</section>
